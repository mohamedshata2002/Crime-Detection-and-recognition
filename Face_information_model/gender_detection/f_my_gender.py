...
class Gender_Model():
    ...
    def loadModel(self):
        ...
        # --------------------------
        # Load weights from a local path
        weights_path = "E:\\workstation\\project\\project\\crime_detection\\Face_information_model\\gender_detection\\gender_model_weights.h5"
